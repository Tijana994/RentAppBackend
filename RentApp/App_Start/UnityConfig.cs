...
namespace RentApp
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IBranchReservationRepository, BranchReservationRepository>();
            container.RegisterType<IPicRepository, PicRepository>();
            ...
            container.RegisterType<ISecureDataFormat<AuthenticationTicket>, CustomJwtFormat>(new InjectionConstructor("http://localhost:51432"));
